...
/// Struk TIDAK disimpan di sini — pelanggan mengambil struk
/// di halaman Notifikasi ketika pesanan sudah berstatus Selesai.
                    ...
                    children: [
                      ...
                      Image.asset(
                        ...
                        errorBuilder: (context, error, stackTrace) =>
                            const Icon(Icons.store_mall_directory,
                                size: 100, color: Color(0xFF339F16)),
                      ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border:
                              Border.all(color: const Color(0xFF339F16).withOpacity(0.4)),
                        ),
                        child: const Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Struk dapat diambil di halaman Notifikasi setelah pesanan Selesai.',
                                style: TextStyle(
                      ...
                      // Subtitle
                      const Text(
                        'Pesanan sedang menunggu\nkonfirmasi dari toko MbahMeth.',
